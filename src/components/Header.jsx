...
const Header = ({ isAuthenticated }) => {
  return (
    <div className="w-[100%] h-[30px] flex items-center py-6 px-5 border-solid border-b-[2.5px] border-[#dddddd]">
      {isAuthenticated ? (
        <div className="flex items-center justify-between w-[100%]">
          <button
            className="cursor-pointer hover:text-[#2EC4B6] active:text-black"
            onClick={() => {
              console.log('카테고리 메뉴 띄우기');
            }}
          >
          ...
          <div className="flex items-center justify-between w-[55px]">
            <Link to="/alarm">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="bell" className="w-6 h-6 fill-current">
