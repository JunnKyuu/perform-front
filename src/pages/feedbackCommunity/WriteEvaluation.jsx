...
const WriteEvaluation = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      if (!accessToken) {
        navigate('/login', { state: { from: '/feedback/write-evaluation' } });
        return;
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('reviewPost', JSON.stringify(reviewPostObject));
  ...
  return (
    <div className="max-w-[600px] min-h-[100vh] mx-auto p-4 bg-white">
      ...
      <div className="flex items-center justify-between mt-8 mb-4">
        <h1 className="text-xl font-GmarketBold">새 심사 게시글 작성</h1>
        <button
          type="button"
